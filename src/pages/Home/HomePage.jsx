  ...
  return (
    <>
        <div className={styles.promoBlock}>
            <h2 className={styles.promoBlockTitle}>Cozy recipes for rainy nights, lazy weekends and laughter-filled dinners.</h2>
            <br />
            <p className={styles.promoBlockSubtitle}>Every recipe tells a story — let’s cook the ones you’ll want to remember.</p>
        </div>
